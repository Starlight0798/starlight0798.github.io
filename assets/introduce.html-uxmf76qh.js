import{_ as n,o as s,c as a,e}from"./app--8uhWfqp.js";const t={},p=e(`<h2 id="_2024-4-7" tabindex="-1"><a class="header-anchor" href="#_2024-4-7" aria-hidden="true">#</a> 2024-4-7</h2><p>Hello! 我正在南开大学就读本科信息安全专业，欢迎加我qq or Wx聊天！</p><p>本人目前掌握以下技能：</p><ul><li>Python : 深度学习，机器学习，爬虫</li><li>C++：面向对象编程，网络编程</li><li>SQL：增删改查</li><li>安全逆向工具如IDA, OLLYDBG, X64DBG</li></ul><p>​ 最近在研究Vue前端，看到了vuepress这个主题，好用就拿来了，顺便学了下Typescript的写法，不得不说类型检查是真的yyds。</p><p>​ 写博客就是要高效，不能写完还得vuepress build，打开dist文件夹，切换分支上传，这样也太慢了。因此我写了个yml Github工作流，写完push完md即可自动部署，在这里分享一下：</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">name</span><span class="token punctuation">:</span> Deploy VuePress Site
